...
import { CardHint } from "@/components/blocks/CardHint";
...
<CardHint type="info" title="Template Info Callout">
  <p className="my-0">Hello, This is not a test</p>
</CardHint>

<br />

<CardHint type="error" title="Template Error Callout">
  <p className="my-0">Hello, This is not a test</p>
</CardHint>

<br />

<CardHint type="warning" title="Template Warning Callout">
  <p className="my-0">Hello, This is not a test</p>
</CardHint>
...
<CardHint type="warning">
  <p className="my-0">Hello, This is not a test</p>
</CardHint>

<br />

<CardHint type="warning" calloutText="What about those matrices?!">
  <p className="my-0">Hello, This is not a test</p>
</CardHint>
